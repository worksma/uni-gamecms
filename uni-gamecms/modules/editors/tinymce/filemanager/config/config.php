...
if(!file_exists($_SERVER["DOCUMENT_ROOT"] . '/files/filemanager/' . $user_path . '/')) {
	mkdir($_SERVER["DOCUMENT_ROOT"] . '/files/filemanager/' . $user_path . '/', 0777);
}
if(!file_exists($_SERVER["DOCUMENT_ROOT"] . '/files/thumbs/' . $user_path . '/')) {
	mkdir($_SERVER["DOCUMENT_ROOT"] . '/files/thumbs/' . $user_path . '/', 0777);
}
...
$config = array(
    ...
    */
    ...
    'extract_files'                           => false,
    'copy_cut_files'                          => $access['copy_cut_files'], // for copy/cut files
    'copy_cut_dirs'                           => $access['copy_cut_dirs'], // for copy/cut directories
    'chmod_files'                             => $access['chmod_files'], // change file permissions
    'chmod_dirs'                              => $access['chmod_dirs'], // change folder permissions
    'preview_text_files'                      => $access['preview_text_files'], // eg.: txt, log etc.
    'edit_text_files'                         => $access['edit_text_files'], // eg.: txt, log etc.
    'create_text_files'                       => $access['create_text_files'], // only create files with exts. defined in $config['editable_text_file_exts']
    ...
    //**********************
    'ext_img'                                 => explode(" ", $settings['ext_img']), //Images
    'ext_file'                                => explode(" ", $settings['ext_file']), //Files
    'ext_video'                               => explode(" ", $settings['ext_video']), //Video
    'ext_music'                               => explode(" ", $settings['ext_music']), //Audio
    'ext_misc'                                => explode(" ", $settings['ext_misc']), //Archives
    ...
    //*********************
    'ext_blacklist'							  => ['php', 'js'],//['exe','bat','jpg'],
