...
CREATE TABLE IF NOT EXISTS `admins__services` (
  ...
  `service` int(9) NOT NULL,
  `service_time` int(9) NOT NULL,
  ...
  `immunity_und` int(9) NOT NULL DEFAULT '0',
  `sb_group_und` varchar(120) NOT NULL DEFAULT 'none',
  `previous_group` int(9) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `bans` (
  ...
  `closed` int(9) NOT NULL DEFAULT '0',
  `bid` int(9) NOT NULL DEFAULT '0',
  `have_answer` int(9) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `config` (
  ...
  `violations_number` int(9) NOT NULL,
  `violations_delta` varchar(5) NOT NULL,
  `ban_time` varchar(5) NOT NULL,
  `protect` int(9) NOT NULL,
  `update_server` int(9) NOT NULL DEFAULT '1',
  `stat` int(9) NOT NULL,
  `stat_number` varchar(5) NOT NULL,
  `show_news` int(9) NOT NULL DEFAULT '3',
  `show_events` int(9) DEFAULT '3',
  `bank` float NOT NULL DEFAULT '0',
  `date` date NOT NULL,
  `cont` int(9) NOT NULL DEFAULT '2',
  `col_nick` int(9) NOT NULL DEFAULT '1',
  `col_pass` int(9) NOT NULL DEFAULT '1',
  `col_type` int(9) NOT NULL DEFAULT '1',
  `conf_us` int(9) NOT NULL DEFAULT '1',
  `cote` int(9) NOT NULL DEFAULT '1',
  `widgets_type` int(9) NOT NULL DEFAULT '1',
  `vk_group` int(9) NOT NULL DEFAULT '2',
  `vk_group_id` varchar(80) NOT NULL DEFAULT '97860459',
  `vk_admin` int(9) NOT NULL DEFAULT '2',
  `vk_admin_id` varchar(80) NOT NULL DEFAULT '139146346',
  `disp_last_online` int(9) NOT NULL DEFAULT '1',
  `new_year` int(9) NOT NULL DEFAULT '0',
  `win_day` int(9) NOT NULL DEFAULT '0',
  `copyright_key` varchar(40) NOT NULL DEFAULT '',
  `developer_mode` int(9) NOT NULL DEFAULT '2',
  `off` int(9) NOT NULL DEFAULT '2',
  `dell_admin_time` varchar(20) NOT NULL DEFAULT '2016-10-09 01:00:00',
  `global_ban` int(9) NOT NULL DEFAULT '2',
  `time_zone` varchar(25) NOT NULL DEFAULT 'Etc/GMT-3',
  `protocol` int(9) NOT NULL DEFAULT '1',
  `code` varchar(20) NOT NULL DEFAULT '',
  `cache` int(9) NOT NULL DEFAULT '1',
  `salt` varchar(10) NOT NULL DEFAULT '',
  `ip_protect` int(9) NOT NULL DEFAULT '2',
  `privacy_policy` int(9) NOT NULL DEFAULT '2',
  `captcha` varchar(50) NOT NULL DEFAULT '2',
  `token` int(9) NOT NULL DEFAULT '1',
  `caching` int(9) NOT NULL DEFAULT '2',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `config__email` (
  ...
  `port` int(9) NOT NULL DEFAULT '25',
  `host` varchar(255) NOT NULL DEFAULT '',
  `password` varchar(255) NOT NULL DEFAULT '',
  `charset` varchar(20) NOT NULL DEFAULT 'UTF-8',
  `from_email` varchar(255) NOT NULL DEFAULT '',
  `use_email` int(9) NOT NULL DEFAULT '2',
  `id` int(9) NOT NULL AUTO_INCREMENT,
  `verify_peers` int(9) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `config__prices` (
  ...
  `referral_program` int(9) NOT NULL DEFAULT '2',
  `referral_percent` int(9) NOT NULL DEFAULT '5',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `config__secondary` (
  `id` int(9) NOT NULL AUTO_INCREMENT,
  `vk_api` int(9) NOT NULL DEFAULT '2',
  `vk_id` varchar(50) DEFAULT '',
  `vk_key` varchar(50) DEFAULT '',
  `vk_service_key` varchar(100) DEFAULT '',
  `steam_api` int(9) NOT NULL DEFAULT '2',
  `steam_key` varchar(50) DEFAULT '',
  `fb_api` int(9) NOT NULL DEFAULT '2',
  `fb_id` varchar(20) DEFAULT NULL,
  `fb_key` varchar(50) DEFAULT NULL,
  `mon_gap` int(9) NOT NULL,
  `mon_time` int(9) NOT NULL,
  `mon_api` int(9) NOT NULL DEFAULT '0',
  `mon_key` varchar(15) NOT NULL DEFAULT '',
  `bans_lim` int(9) NOT NULL DEFAULT '30',
  `muts_lim` int(9) NOT NULL DEFAULT '30',
  `users_lim` int(9) NOT NULL DEFAULT '12',
  `bans_lim2` int(9) NOT NULL DEFAULT '30',
  `news_lim` int(9) NOT NULL DEFAULT '10',
  ...
  `return_services` int(9) NOT NULL DEFAULT '1',
  `bad_nicks_act` int(9) NOT NULL DEFAULT '2',
  `min_amount` float DEFAULT '10',
  `bonuses` int(9) NOT NULL DEFAULT '2',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `config__strings` (`id`, `data`) VALUES (1, ''), (2, 'a:10:{s:12:\"file_manager\";s:1:\"1\";s:18:\"file_manager_theme\";s:1:\"1\";s:10:\"img_editor\";s:1:\"1\";s:16:\"img_editor_theme\";s:1:\"1\";s:13:\"file_max_size\";s:2:\"10\";s:7:\"ext_img\";s:20:\"jpg jpeg png gif bmp\";s:9:\"ext_music\";s:7:\"mp3 wav\";s:8:\"ext_misc\";s:18:\"zip rar 7z tar iso\";s:8:\"ext_file\";s:184:\"dem doc docx rtf pdf xls xlsx txt csv xhtml psd log fla xml ade adp mdb accdb ppt pptx odt ots ott odb odg otp otg odf ods odp css ai kmz dwg dxf hpgl plt spl step stp iges igs sat cgm\";s:9:\"ext_video\";s:25:\"mpeg m4v mp4 avi flv webm\";}'), (3, 'a:0:{}');
...
INSERT INTO `config__updates`(`id`, `name`, `url`) VALUES (1, "Германия", "worksma.ru"), (2, "Россия", "vfoxcms.ru");
...
CREATE TABLE IF NOT EXISTS `events` (
  ...
  `data_id` int(9) DEFAULT NULL,
  `sec_data_id` int(9) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `forums__messages` (
  ...
  `edited_by` int(9) NOT NULL DEFAULT '0',
...
INSERT INTO `last_online` (`id`, `user_id`) VALUES (1, 1);
...
INSERT INTO `levels__profile` (`id`, `level`, `name`, `experience`) VALUES(1, 0, 'Серебро - I', 0),(2, 1, 'Серебро - II', 200),(3, 2, 'Серебро - III', 500),(4, 3, 'Серебро - IV', 700),(5, 4, 'Серебро - Элита', 1000),(6, 5, 'Серебро - Великий Магистр', 1500),(7, 6, 'Золотая Звезда - I', 1800),(8, 7, 'Золотая Звезда - II', 2500),(9, 8, 'Золотая Звезда - III', 3200),(10, 9, 'Золотая Звезда - Магистр', 3900),(11, 10, 'Магистр-Хранитель - I', 5000),(12, 11, 'Магистр-Хранитель - II', 8000),(13, 12, 'Магистр-Хранитель - Элита', 10000),(14, 13, 'Заслуженный Магистр-Хранитель', 15000),(15, 14, 'Легендарный Беркут', 20000),(16, 15, 'Легендарный Беркут-Магистр', 30000),(17, 16, 'Великий Магистр Высшего Ранга', 50000),(18, 17, 'Всемирная Элита', 100000);

CREATE TABLE IF NOT EXISTS `menu` (
  `id` int(9) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `link` varchar(255) NOT NULL,
  `menu__sub` int(9) NOT NULL DEFAULT '0',
  `poz` int(9) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `monitoring` (
  ...
  `players_now` int(9) NOT NULL,
  `players_max` int(9) NOT NULL,
...
INSERT INTO `news__classes` (`id`, `name`) VALUES (1, 'Новости проекта');

CREATE TABLE IF NOT EXISTS `news__comments` (
  `id` int(9) NOT NULL AUTO_INCREMENT,
  `user_id` int(9) NOT NULL,
  `new_id` int(9) NOT NULL,
  `text` text NOT NULL,
  `date` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `pages` (
  ...
  `kind` int(9) NOT NULL DEFAULT '1',
  `image` varchar(255) NOT NULL DEFAULT 'files/miniatures/standard.jpg',
  `robots` int(9) NOT NULL DEFAULT '1',
  `privacy` int(9) NOT NULL DEFAULT '1',
  `type` int(9) NOT NULL DEFAULT '1',
  `active` int(9) NOT NULL DEFAULT '1',
  `module` int(9) NOT NULL DEFAULT '0',
  `page` int(9) NOT NULL DEFAULT '0',
  `class` int(9) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `pages__classes` (`id`, `name`) VALUES (1, ''), (2, 'pages');
...
CREATE TABLE IF NOT EXISTS `pm__dialogs` (
  ...
  `dell_1` int(9) NOT NULL DEFAULT '0',
  `dell_2` int(9) NOT NULL DEFAULT '0',
  `date` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `servers` (
  ...
  `ftp_port` int(9) NOT NULL DEFAULT '21',
  ...
  `db_code` int(9) NOT NULL DEFAULT '1',
  `st_type` int(9) NOT NULL DEFAULT '0',
  ...
  `st_db_code` int(9) NOT NULL DEFAULT '0',
  `st_sort_type` int(9) NOT NULL DEFAULT '1',
  `pass_prifix` varchar(10) NOT NULL DEFAULT '_pw',
  `discount` int(9) DEFAULT '0',
  `rcon` int(9) DEFAULT '2',
  `rcon_password` varchar(256) DEFAULT '',
  `show` int(9) DEFAULT '1',
  `united` int(9) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `servers__commands` (
  `id` int(9) NOT NULL AUTO_INCREMENT,
  `server` int(9) DEFAULT '0',
  `reload_admins` varchar(64) DEFAULT '',
  `kick` varchar(64) DEFAULT '',
  `ban` varchar(64) DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `services` (
  ...
  `server` int(9) NOT NULL,
  `text` text NOT NULL,
  `trim` int(9) NOT NULL DEFAULT '0',
  `immunity` int(9) NOT NULL DEFAULT '0',
  `sale` int(9) NOT NULL DEFAULT '1',
  `users_group` int(9) NOT NULL DEFAULT '0',
  `sb_group` varchar(120) NOT NULL DEFAULT '',
  `show_adm` int(9) NOT NULL DEFAULT '1',
  `discount` int(9) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `stickers` (`id`, `name`) VALUES (1, 'Ничоси'), (2, 'Персик'), (3, 'Животные'), (4, 'Смайлы'), (5, 'Мемы');

CREATE TABLE IF NOT EXISTS `thanks` (
  `id` int(9) NOT NULL AUTO_INCREMENT,
  `mes_id` int(9) NOT NULL,
  `author` int(9) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `verification` int(9) NOT NULL DEFAULT '0',
  ...
  `dell` int(9) NOT NULL DEFAULT '0',
  `last_topic` int(9) NOT NULL DEFAULT '0',
  `reit` int(9) DEFAULT '0',
  `proc` int(9) NOT NULL DEFAULT '0',
  ...
  `active` int(9) NOT NULL DEFAULT '1',
  `im` int(9) NOT NULL DEFAULT '1',
  `telegram` varchar(50) NOT NULL DEFAULT '',
  `prefix` varchar(30) DEFAULT '',
  `game_time` int(9) NOT NULL DEFAULT '0',
  `protect` int(9) NOT NULL DEFAULT '2',
  `invited` int(9) DEFAULT '0',
  `email_notice` int(9) NOT NULL DEFAULT '1',
...
INSERT INTO `users__groups` (`id`, `name`, `color`, `rights`) VALUES (1, 'Создатель', '#d1574d;', 'amcdybqfgpltweriousjh'), (2, 'Пользователь', '#45688E;', 'aw'), (3, 'Временный бан', '#000000', 'z'), (4, 'Вечный бан', '#404040', 'x');
